...
// Get Dhaka city areas (all active areas, no district filter)
exports.getDhakaCityAreas = async (req, res) => {
    try {
        // Get all active Dhaka City areas without district filter
        const dhakaAreas = await DhakaCity.find().sort({ name: 1 });
        ...
        console.error('Error fetching Dhaka City areas:', error);
        return sendResponse({
            res,
            statusCode: 500,
            success: false,
